						...
						<CardBody>
							...
							<Chart
								config={{
									...
									axis: { rotated: !0 },
									size: { height: 400 },
									color: { pattern: ["#7460ee", "#4fc3f7", "#fc4b6c", "#343a40"] },
								}}
							/>
						</CardBody>
					</Card>
						...
						<CardBody>
							...
							<Chart
								config={{
									...
									size: { height: 400 },
									color: {
										pattern: ['#7460ee', '#ced4da', '#4fc3f7', '#fc4b6c']
									}
								}}
							/>
						</CardBody>
						...
						<CardBody>
							...
							<Chart
								config={{
									...
									color: { pattern: ["#7460ee", "#4fc3f7", "#a1aab2"] }
								}}
							/>
						</CardBody>
					</Card>
						...
						<CardBody>
							...
							<Chart
								config={{
									...
									color: { pattern: ["#7460ee", "#4fc3f7", "#fc4b6c"] }
								}}
							/>
						</CardBody>
					</Card>
							...
							<Chart
								config={{
									data: {
										...
										type: "bar",
										colors: { data1: "#4fc3f7", data2: "#7460ee" }
									},
									grid: { y: { show: !0 } },
									size: { height: 400 }
								}}
						...
						<CardBody>
							...
							<Chart
								config={{
									...
									grid: { x: { show: !0 } },
									size: { height: 400 },
									color: { pattern: ["#343a40", "#4fc3f7", "#fc4b6c", "#7460ee", "#ced4da"] }
								}}
							/>
						</CardBody>
					</Card>
						...
						<CardBody>
							...
							<Chart
								config={{
									...
									grid: { y: { show: !0 } },
									size: { height: 400 },
									color: { pattern: ["#7460ee", "#343a40", "#4fc3f7"] }
								}}
							/>
						</CardBody>
					</Card>
