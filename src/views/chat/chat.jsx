...
class Chat extends React.Component {
    ...
    switch (chatindex) {
      ...
      case 'chat2':
        this.setState(
            ...
            chats2: this.state.chats2.concat([
              {
                username: 'Kevin Hsu',
                content: (
                  <span>{ReactDOM.findDOMNode(this.refs.msg2).value}</span>
                ),
                img: user1
              }
            ])
          ...
          () => {
            ReactDOM.findDOMNode(this.refs.msg2).value = '';
          }
        );
        break;
      case 'chat3':
        this.setState(
            ...
            chats3: this.state.chats3.concat([
              {
                username: 'Kevin Hsu',
                content: (
                  <span>{ReactDOM.findDOMNode(this.refs.msg3).value}</span>
                ),
                img: user1
              }
            ])
          ...
          () => {
            ReactDOM.findDOMNode(this.refs.msg3).value = '';
          }
        );
        break;
      case 'chat4':
        this.setState(
            ...
            chats4: this.state.chats4.concat([
              {
                username: 'Kevin Hsu',
                content: (
                  <span>{ReactDOM.findDOMNode(this.refs.msg4).value}</span>
                ),
                img: user1
              }
            ])
          ...
          () => {
            ReactDOM.findDOMNode(this.refs.msg4).value = '';
          }
        );
        break;
      default:
  ...
  render() {
    ...
    const { chats, chats2, chats3, chats4 } = this.state;
    ...
    return (
      <div>
        ...
        <div className="right-part bg-white">
          <TabContent activeTab={this.state.activeTab} ref="chats">
            {/*--------------------------------------------------------------------------------*/}
            {/* Tab1                                                                     */}
            {/*--------------------------------------------------------------------------------*/}
            <TabPane tabId={0}>
